...
class ImageSorterUI(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self.status_label = ctk.CTkLabel(self.nav_frame, text="0 / 0", font=("Arial", 14, "bold"))
    ...
    def load_source_folder(self):
        ...
        if self.image_paths:
            ...
            self.image_label.configure(text="No images found in folder", image="")
    ...
    def move_current_image(self, target_path):
        ...
        try:
            ...
            if not self.image_paths:
                self.image_label.configure(text="All Done! 🎉", image="")
                self.update_ui_state(has_images=False)
            else:
    ...
    def display_image(self):
        ...
        self.status_label.configure(text=f"{self.current_index + 1} / {len(self.image_paths)}")
